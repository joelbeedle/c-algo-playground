...
struct LinkedList {
    ...
    void (*printFunc)(void*);     // Function pointer to the type-specific print function
    int (*compareFunc)(void*, void*); // Function pointer to the type-specific compare function
};
